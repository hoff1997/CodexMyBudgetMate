...
export function NetWorthClient({ assets, liabilities, snapshots, monthlySnapshots, accounts, canEdit }: Props) {
  ...
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-4 px-6 pb-16 pt-6 md:px-8 md:pb-8">
      <header className="flex flex-wrap items-center justify-between gap-2">
        <div>
          <h1 className="text-xl font-semibold text-[#3D3D3D]">Net worth</h1>
