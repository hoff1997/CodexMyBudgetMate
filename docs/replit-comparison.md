...
| `replitenvelope-planning.tsx` | `app/envelope-planning/page.tsx` + `planner-client.tsx` | ✅ Ported | Annual/target/per-pay maths, due-date progress bars, notes, Supabase patch route in place. Remaining: category grouping, CSV export, add/transfer dialogs, seeding helper. |
